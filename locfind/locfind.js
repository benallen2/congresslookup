...
function pos(loc){
  ...
  $.ajax({
    url: "https://congress.api.sunlightfoundation.com/legislators/locate?latitude=" + latitude + "&longitude=" + longitude + "&apikey=dc06e77466b24aad948f211c8cdc4a29",
  })
  .done(function ( data ){
    console.log(data);
    if (data.results.length == 0){
      alert("Unable to find your Representatives!");
      location.reload();
    }else{
      $(".repsDiv").fadeIn(500);
